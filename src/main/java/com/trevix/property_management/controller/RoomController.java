...
public class RoomController {
    ...
    public ResponseEntity<ApiResponse<List<RoomResponse>>> getRoomsByProperty(
            @AuthenticationPrincipal CustomUserDetails principal,
            @PathVariable UUID propertyId,
            HttpServletRequest httpRequest) {
        verifyPropertyOwnership(propertyId, principal.getId());
    ...
    public ResponseEntity<ApiResponse<Void>> activateRoom(
            @AuthenticationPrincipal CustomUserDetails principal,
            @PathVariable UUID roomId,
            HttpServletRequest httpRequest) {
        verifyRoomOwnership(roomId, principal.getId());
    ...
    private void verifyPropertyOwnership(UUID propertyId, UUID ownerId) {
    ...
    private RoomResponse verifyRoomOwnership(UUID roomId, UUID ownerId) {
